              ...
              >
                ...
                <div className="flex gap-3 mt-6 flex-wrap">
                  <a
                    href={mapLink}
                    target="_blank"
                    className="border border-[#C9A86A] rounded-full px-4 py-2"
                  >
                    Directions
                  </a>

                  {showUpload && uploadLink && (
                    <a
                      href={uploadLink}
                      target="_blank"
                      className="border border-slate-300 rounded-full px-4 py-2"
                    >
                      Upload Photos
                    </a>
                  )}
                  ...
                  {showGallery && galleryLink && (
                    <a
                      href={galleryLink}
                      target="_blank"
                      className="bg-[#C9A86A] text-black rounded-full px-4 py-2"
                    >
                      View Gallery
                    </a>
                  )}
